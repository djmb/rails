...
class ActiveRecord::Encryption::EncryptorWithoutCompressionTest < ActiveRecord::EncryptionTestCase
  setup do
    @secret_key = "This is my secret 256 bits key!!"
    @encryptor = ActiveRecord::Encryption::EncryptorWithoutCompression.new
  end
  ...
  test "content is not compressed" do
